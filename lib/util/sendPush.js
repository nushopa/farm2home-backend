...
// expo-server-sdk ships ESM-only builds in recent versions, so it can't be
// pulled in with a top-level require(). Load it lazily via dynamic import
// and cache the client so we only pay the import cost once.
