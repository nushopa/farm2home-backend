...
const Device = require("../../models/Device"); // adjust path to match your models folder
...
const sendPushNotification = async ({
  ...
  await handlePushTickets(tickets, messages);

  return tickets;
};


async function handlePushTickets(tickets, messages) {
  const staleTokens = [];
